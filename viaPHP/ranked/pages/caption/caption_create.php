<?php
	...
	$data = array();
	$captionCode = (isset($_GET["code"])) ? ($_GET["code"]) : ("");						//$eventNo = 'C000001';	$countCode = 'voK2xX';
	
	if($captionCode != "") {
		$data["caption"] 		= fun_getCaptionData(array("Code" => $captionCode) );	//獲取計數器資料
	}
	else {
		$data["caption"] = array( 
			"ID" 							=> "0",
						...
						<div class="div_edit form-row" id = "div_counters">
							...
							<div class="row col-12 border-bottom">
								...
								<div class="form-group col-md-6 col-sm-6">
									...
									<input type="text" class="form-control" id="inputTitle" name="input[Title]" value="<?=$data["caption"]["Title"]; ?>" placeholder="字幕組標題" data-toggle="tooltip" data-placement="top" title="字幕組標題"	/>
								</div>
							...
							<div class="row col-12 border-bottom">
								...
								<div class="form-group col-6 p-0">
									<div class="col-12">
										<label>Margin <i class="fas fa-exclamation-circle" data-toggle="tooltip" data-placement="top" title="字串間距，單位為px"></i></label>
									</div>
									<div class="d-flex">
										<div class="col-md-3">
