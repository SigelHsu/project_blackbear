						...
						<div class="div_edit form-row" id = "div_counters">
							...
							<div class="row col-12 border-bottom">
								<div class="form-group col-md-3">
									...
									<input type="text" class="form-control" id="inputNo" name="input[No]" value="<?=$data["counter"]["No"]; ?>" placeholder="(系統生成)" disabled />
								...
								<div class="form-group col-md-3">
									...
									<input type="text" class="form-control" id="inputCode" name="input[Code]" value="<?=$data["counter"]["Code"]; ?>" placeholder="(系統生成)" disabled />
								</div>
