...
<?php
	...
	$returnData["ResultData"]["Role"] 	= $resData["RoleResult"];																						//處理後要返回，以陣列形式儲存的玩家角色紀錄(用來取代 box_orderMod原有的)
	...
	//重新處理角色順序
	{
		$cls_withTurnUPD 									= new cls_withTurn($returnData["ResultData"]["Role"], array("Turn" => $setData["Turn"]));
