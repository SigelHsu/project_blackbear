						...
						<div class="div_edit form-row" id = "div_events">
							...
							<div class="row col-12 border-bottom">
								<div class="form-group col-md-6 col-sm-6">
									...
									<div id="div_setBGImg" class="div_setbg">
									...
									<div id="div_setBGCol" class="div_setbg d-none">
							...
							<div class="row col-12 border-bottom ">
								<div class="form-group col-md-6 col-sm-6">
									...
									<div id="div_setColImg" class="div_setbg">
									...
									<div id="div_setColCol" class="div_setbg d-none">
								...
								<div class="form-group col-md-12 mb-0">
									<label class="mb-0">Every Column's Width Setting</label>
							...
							<div class="row align-items-center col-md-12 border-bottom mt-2 ml-1">
								<div class="row col-md-12">
									<div class="form-group col-md-3 col-sm-3">
										<label>Rule</label>
										<input type="hidden" 	class="form-control" name="input[RankRule][ID][]" 	value="0" 												placeholder="RuleTag ID">
